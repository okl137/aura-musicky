const API_BASE = window.API_BASE || (window.location.hostname === 'localhost' ? 'http://localhost:3000' : 'https://your-render-backend.onrender.com');
    ...
    */
    ...
    async function playSong(item, index) {
        ...
        try {
            ...
            console.error(e);
            alert('播放出错: ' + (e.response?.data?.error || e.message));
        }
    }
